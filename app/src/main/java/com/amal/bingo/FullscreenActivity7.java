 ...
 */
public class FullscreenActivity7 extends AppCompatActivity {
    /**
    ...
    public static com.amal.bingo.FullscreenActivity7 activity7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fullscreen7);
        ...
        textView1.setAnimation(inFromBottomAnimation(1500));
        ...
        host.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.amal.bingo.FullscreenActivity7.this, com.amal.bingo.FullscreenActivity8.class);
                ...
                if(!manager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    ...
                    startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(com.amal.bingo.FullscreenActivity7.this).toBundle());
                }
            }
        });
